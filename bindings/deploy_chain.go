...
// Deploy is a paid mutator transaction binding the contract method 0x6b74d941.
//
// Solidity: function deploy(uint256 chainID, uint64 genesisL1Number, bytes32 genesisL2Hash, bytes32 genesisL2StateRoot, uint64 genesisL2Time, (uint32,uint32,uint64,address) gasConfig, address batcherAddress, address unsafeBlockSigner, address proposer) returns()
func (_DeployChain *DeployChainTransactor) Deploy(opts *bind.TransactOpts, chainID *big.Int, genesisL1Number uint64, genesisL2Hash [32]byte, genesisL2StateRoot [32]byte, genesisL2Time uint64, gasConfig DeployChainGasConfiguration, batcherAddress common.Address, unsafeBlockSigner common.Address, proposer common.Address) (*types.Transaction, error) {
	return _DeployChain.contract.Transact(opts, "deploy", chainID, genesisL1Number, genesisL2Hash, genesisL2StateRoot, genesisL2Time, gasConfig, batcherAddress, unsafeBlockSigner, proposer)
}
...
func (_DeployChain *DeployChainSession) Deploy(chainID *big.Int, genesisL1Number uint64, genesisL2Hash [32]byte, genesisL2StateRoot [32]byte, genesisL2Time uint64, gasConfig DeployChainGasConfiguration, batcherAddress common.Address, unsafeBlockSigner common.Address, proposer common.Address) (*types.Transaction, error) {
	return _DeployChain.Contract.Deploy(&_DeployChain.TransactOpts, chainID, genesisL1Number, genesisL2Hash, genesisL2StateRoot, genesisL2Time, gasConfig, batcherAddress, unsafeBlockSigner, proposer)
}

// Deploy is a paid mutator transaction binding the contract method 0x6b74d941.
//
// Solidity: function deploy(uint256 chainID, uint64 genesisL1Number, bytes32 genesisL2Hash, bytes32 genesisL2StateRoot, uint64 genesisL2Time, (uint32,uint32,uint64,address) gasConfig, address batcherAddress, address unsafeBlockSigner, address proposer) returns()
func (_DeployChain *DeployChainTransactorSession) Deploy(chainID *big.Int, genesisL1Number uint64, genesisL2Hash [32]byte, genesisL2StateRoot [32]byte, genesisL2Time uint64, gasConfig DeployChainGasConfiguration, batcherAddress common.Address, unsafeBlockSigner common.Address, proposer common.Address) (*types.Transaction, error) {
	return _DeployChain.Contract.Deploy(&_DeployChain.TransactOpts, chainID, genesisL1Number, genesisL2Hash, genesisL2StateRoot, genesisL2Time, gasConfig, batcherAddress, unsafeBlockSigner, proposer)
}
